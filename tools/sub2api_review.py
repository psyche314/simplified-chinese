...
【项目背景】
这是一个带有成人内容的西幻/中世纪风格 Ren'Py RPG。世界观背景只影响有依据的语体和专名，不会让所有对白自动变成古风。玩家在莫肯大陆旅行，与山羊部落、熊族、狼人、缚灵者、符文守护者等人物和实体互动；战斗文本、菜单、道具说明、剧情对白和书面记录的写法不同。上下文中的“neighbor”是相邻原文与译文，仅用于判断指代、说话者、术语和语气，不是新的待审对象。
