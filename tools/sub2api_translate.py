...
PROJECT_GLOSSARY = (
    ...
    (
        "Spritebinder",
        "缚灵者",
        "八个光谱实体的集体意识，以多只幽灵般的手显现；不要机械译成“精灵缚者”，也不要把正式名称译成“八臂鬼”。",
    ),
    (
        "Eversprout",
        "永生芽",
    ...
    (
        "Moine",
        "莫因",
        "game_properties.rpy 中定义的麋鹿角色名（变量 mo）；不要按普通名词或职业“修道士”翻译。",
    ),
    (
        "handing you three a pile of gold",
        "把一堆金币递给你们三人",
        "main_lusterfield02.rpy 的牌局语境中，原文有语法笔误；四人牌局里 you three 指除福克外的三名玩家，不是“三堆金币”。",
    ),
    (
        "Tetto",
        "泰托",
