# Generated from developer English menu strings.
...
translate schinese_rewrite strings:
    ...
    new "一种能在2回合内使饮用者的命中率提高20点的药剂。战斗外饮用时，则会暂时提高敏捷。"

    old "A Potion that can increase drinker's both defenses by 40 for 2 rounds."
    new "一种能在2回合内使饮用者的两项防御各提高40点的药剂。"
    ...
    new "一种能在2回合内使饮用者的两项防御各提高40点的药剂。战斗外饮用时，则会暂时提高坚韧。"
    ...
    new "一种饰品：普通攻击伤害会随敌人的欲望百分比提高；敌人损失的生命值越多，你的调情效果就越强。"
    ...
    new "一种小巧却色彩鲜艳的花，通常放在坟墓上缅怀逝者，也可作为用竹水泡茶的原料。"
    ...
    new "熊地精身上的皮带，想必是从山羊那里偷来的。用来把东西捆在一起。"
    ...
    new "部落打造的长矛，内部蕴含的魔力会给使用者带来非同寻常的强化。"
    ...
    new "仅对熊地精有效的镇静剂。目标生命值低于50%或欲望高于50%时使用。目标会迅速入睡，并分泌更多唾液。"
    ...
    new "一种小型手工具，常用于在花园中挖土，以及抹平或铺开砂浆。"
    ...
    new "敏捷（AGI）决定[e]的速度，包括命中率、暴击伤害、暴击率和闪避率。"
    ...
    new "作为快递任务，奥利告诉我需要帮他从一位老朋友那里取药。{p}我得带着30点力量药水回去向奥利报告。"
    ...
    new "作为快递任务，奥利告诉我需要帮他从一位老朋友那里取药。{p}我得用哈斯凯尔给我的药粉麻醉两只熊地精。"
    ...
    new "受缚：{p} 目标无法攻击或使用技能。尝试挣扎，造成较低伤害并挣脱束缚。"
    ...
    new "已完成：[selected_task.completedtimes]次"
    ...
    new "困惑：{p}目标神志不清，有一半概率会攻击自己。叠加到5层时，目标会被催眠并输掉战斗。"
    ...
    new "已用时：[ribba_dialogues['Controller Time']] / 120分钟"
    ...
    new "在魔法池塘附近发现；池塘里隐藏的饰品可以用牛科生物的精华与魔法流水召唤出来。"
    ...
    new "在长满厚苔的河边发现；它在夜间最为明亮，使用小型弯曲工具在水下挖掘即可找到。"
    ...
    new "只在午夜于河畔桥边出现；完成一系列精准试炼的人才能找到这件饰品。"
    ...
    new "霜巨人鹿首面具的碎片，会随时间再生，是这片大陆上最坚硬的材料之一。"
    ...
    new "冻结：{p} 每层使目标每回合陷入眩晕的概率提高1%。最多叠加30层。达到最大层数后，目标每回合还会受到少量冻伤伤害。"
    ...
    new "焚灭：{p} 对所有敌人造成爆炸伤害。对处于灼伤状态的敌人造成额外伤害，并强化其灼伤效果。"
    ...
    new "俗称砂浆，是莫肯大多数建筑所用的材料，由天然元素与精妙的魔法性质混合而成，能够确保结构稳固。"
    ...
    new "别把它和另一种液体混为一谈。这是一种受奥术魔法加持的强力物质，能把哪怕最难结合的材料粘在一起。用于建筑时，水泥能赋予建筑结构非凡的稳定性，使其抵御岁月的侵蚀。"
    ...
    new "奥利病了 我得去问哈斯凯尔 收集一些治疗他疾病的材料。"
    ...
    new "穿刺打击：{p} 下一回合，普通攻击必定命中并造成暴击；暴击伤害随敏捷提高。"
    ...
    new "从熊地精口腔采集的唾液样本。气味极其刺鼻，可以用来掩盖自身气味。"
    ...
    new "灼伤：{p} 目标每回合持续损失相同数值的生命值。再次施加时只会延长效果持续时间。"
    ...
    new "塞巴斯邀请我今天和奥利在酒馆共进晚餐 我晚上应该在那里见他们。"
    ...
    new "幽灵光球：{p} 目标的下一次攻击会根据光球数量恢复生命值。"
    ...
    new "一支不时在平原周围扎营的热闹马戏团。中央舞台上有精彩的魔术表演，吸引着许多访客，甚至包括来自城市的人。"
    ...
    new "窗户下方有个小地方；如果你的敏捷够高，也许能躲在那里不被发现。"
    ...
    new "生长在大陆北部地区的老桦木，木心致密坚硬，常用于制作家具和建筑材料，以增强稳固性。"
    ...
    new "雪地区域少数近期发生的雪崩地点之一。这里是一处堆满积雪、岩石和被掩埋树木的悬崖，任何靠得太近的人都会面临极大危险。"
    ...
    new "继续操作将刷新任务进度，并删除不必要的字符串类型进度。"
    ...
    new "里巴想让我帮他收集道具，用于他在旋转木马处的下一场演出。"
    ...
    new "说到那些学者，他们似乎隶属于某个部落——一群调查人员，试图追查在奥科事件中逃走的失落幽魂。他们似乎接触过符文，这很可能就是他们来到我们部落的原因。幸运的是，魔法在这里不起作用，让我能在将他们驱逐前套出一些信息。\n\n总之，我不能让这些学者离开，所以我选择先切断他们交流的能力。至少，这些可怜灵魂的某些本能仍显现在他们的双手上；从今以后，就把他们当作那些烦人幽魂的克星吧。"

    old "Speaking of, do ye know how to play Cumrag?"
    new "说起来，你知道怎么玩“精液牌”吗？"
    ...
    new "幽暗森林中由一名狼人最先发现的洞穴群，据说洞中罕见矿物和矿石异常丰富。"
    ...
    new "茂密森林中的一片开垦空地，据说有远古存在的灵魂在空洞周围游荡。"
    ...
    new "坐落在高山脚下的平坦草原，据说高原曾是原初战争的战场，远古之斧坠落后化为了岩石。"
    ...
    new "冒险者最常用的剑。即使是最传奇的英雄也会带着它上战场。"
    ...
    new "切尔福特山洞唯一的入口，这地方似乎已经荒废了一段时间。"
    ...
    new "连接山羊部落群山与大瀑布的河流。{p}除了清爽的河水，这条溪流还栖息着一种苔藓怪物，旅行商人最好避开这条路线。"
    ...
    new "将幽暗森林与狼人领地和野生史莱姆领地分隔开的溪流；这些史莱姆比森林外的更加凶狠危险。"

    old "The waterfall on Kesi Alps connected to the freshwater down south."
    new "凯西阿尔卑斯山上的瀑布，与南方的淡水相连。"
    ...
    new "白色物质……是困在山洞里的弥诺陶洛斯精华；从气味来看，这头公牛的状态似乎很糟。"
    ...
    new "为了品尝黑龙最喜欢的茶，他让我爬上雪境山巅，在那里寻找茶叶。"

    old "Toggles assistive {a=https://www.renpy.org/l/voicing}self-voicing{/a}."
    new "切换辅助{a=https://www.renpy.org/l/voicing}自我朗读{/a}。"
    ...
    new "乌菲让我进入一对计划逃离森林的狼人的藏身处。我需要做出选择。"
    ...
    new "乌菲想让我……杀死山洞里的一只狂野狼人并拿走他的戒指。我应该在幽暗森林附近探索，找出那座山洞。"
    ...
    new "伍尔顿一直在寻找能治愈伏罗病症的材料……也许我应该帮他。"
    ...
    new "你思考着各种选择。那些侍僧正全神贯注地准备仪式，但也许等你察觉时，他们已经完成了仪式。"
    ...
    new "\n将在 [status_expire_day] 天 [status_expire_hour] 小时后失效。"

    old "\nExpires in [status_expire_hour] hours."
    new "\n将在 [status_expire_hour] 小时后失效。"
    ...
    new "一名熊卫兵一直听到奇利冰洞里传来奇怪的声音，他请我调查回声的来源。"
    ...
    new "一把带倒刺的长矛，刺入目标后会牢牢卡住；若不造成严重伤害，几乎无法拔出。鱼叉主要用于在水中猎捕生物，但部落迁往内陆后，如今已很少作为武器使用。"
    ...
    new "专门种植植物和阳具的农夫犬制作的项圈；戴上它就等于成为农夫的所有物。"
    ...
    new "一种生长在骄阳农场的珍稀植物。据农夫说，它能闭合一切非致命伤口，并让食用者迅速恢复精神。"
    ...
    new "一顶由细线织成的兜帽，长长的垂带缠绕在佩戴者脸上。织入其中的魔法能稳定心神，并以微弱的结界守护佩戴者。"
    ...
    new "一套由知名魔法师制作的撩人服装；富有弹性的紧身面料完美贴合穿戴者的身体。"
    ...
    new "这种花因甜美多汁而深受熊族喜爱。它非常适合用来制作茶、啤酒和麦酒。"
    ...
    new "一座被藤蔓掩藏、由残酷盗贼看守的堡垒。敢于进入者将面对险恶的陷阱与危险迷宫；但对他们而言，财富与无视法律的自由正在召唤。"
    ...
    new "一颗蕴含魔法能量的宝石。它在世界深不可测的深处被发现，只有经验丰富的人才能驾驭其中潜力。"
    ...
    new "一把用高品质木材和琴弦制成的大竖琴，声音细腻柔和，有时甚至会被误认为是神明的声音。"
    ...
    new "一种用植物纤维织成的轻薄布料。穿着舒适，尤其适合制作简单衣物和贴身内层。"
    ...
    new "原初之神奥科遗失的战斧。它曾在无尽的战斗中被挥舞，如今斧刃早已变钝并崩缺，但其中的力量依然完好。"
    ...
    new "一条通常围在佩戴者颈上的围巾。它聪慧优雅的外观，或许也能赋予佩戴者真正的智慧。"
    ...
    new "一卷曾属于卡里的卷轴，似乎很久以前就被某种液体浸泡过。触摸它时，竟感到奇异的怀旧……"
    ...
    new "一顶著名吟游诗人的别致绿色帽子，上面装饰着两根来自在平原游荡的传奇生物的羽毛。"
    ...
    new "森林附近的一片沼泽，水面呈明亮的蓝色。{p}池塘中的魔力精华能暂时赋予旅行者活力。"
    ...
    new "一束细长的皮条，由一双顽皮的手扎在一起，是许多皮制物品的组件之一。"
    ...
    new "一种近来用于酿造啤酒的花，能增添苦味，据说饮用后有镇静作用。"
    ...
    new "奥察瓦拉熊族身上脱落的一种硬毛皮。它独特的密度与厚度能帮助熊族抵御严寒，即使不穿衣服也一样。"
    ...
    new "雪地区域附近的一种草药，可用于各种饮料；但据说直接食用会让人觉得自己经历了永恒的冬天。"
    ...
    new "一种通常加入酿酒香草中以增强啤酒风味的草药。虽然它用于帮助旅人抵御疲劳，但也有人报告饮用后做了奇怪的梦。"
    ...
    new "各种花朵整齐地插在装饰性包装里。上面附着一张写着留言的小卡片。"
    ...
    new "一片延伸至地平线之外的广袤雪原，据说这片雪境是天兽约顿的家园，它会在古老观象台上徘徊。"
    ...
    new "一种能把吹哨声变成类似狼人嚎叫声的狼人哨子。它曾用于狼人族群如今已废止的仪式。"
    ...
    new "一种由水晶宝石和草药制成的极稀有混合药剂。饮用后会返还已消耗的属性点，以便重新分配。"
    ...
    new "作为邮差工作的一部分，奥利告诉我需要帮他从一位老朋友那里取药。{p}我需要等两天，让哈斯克尔完成药水。"

    old "As you have knowledge of the past, do you wish to break the barrier?"
    new "既然你了解过去，你想打破这道屏障吗？"
    ...
    new "在诅咒控制伏罗之前，他建议和伍尔顿、我一起回到坍塌的洞穴，完成他的研究。"
    ...
    new "你想离开地下城吗？在完成之前，游戏状态不会保存；柱子上的物品会自动退回你的背包。"

    old "Do you wish to leave? All dungeon status will not be saved."
    new "你想离开吗？地下城的所有状态都不会保存。"
    ...
    new "智力决定[e]的智慧和法术能力，包括法术效果、魔力和欲望抗性。"
    ...
    new "看来到了跟随塞巴斯的时候；你想藏在这里等待，还是放弃跟踪他？"
    ...
    new "这片针叶林以被积雪和倒下的树木覆盖而闻名。由于熊卫兵厚实毛皮带来的出色保暖性，这里通常由他们守卫；这里气温骤降，旅人可能需要多穿些宽松衣物。"
    ...
    new "也许以后{#JogVoteQuest}"

    old "Maybe Later{#amblepatrol}"
    new "也许以后{#amblepatrol}"
