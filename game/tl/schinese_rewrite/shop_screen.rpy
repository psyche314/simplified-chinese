translate schinese_rewrite Sebas_Shopping_17f68e7d:
...
translate schinese_rewrite Sebas_Shopping_Loop_9d8ec6c6:
    ...
    s "雷希姆经常卖给我这种布料，似乎很多日常用品都很常用它。现在售价是 [selected_shopItem.value] 枚金币。"
...
translate schinese_rewrite Sebas_Shopping_Loop_9ffd8732:
    ...
    s "这东西闻起来怪怪的。我不知道里面是什么，居然让我产生了幻觉……不过我见过一些商人抽这玩意儿。所以……[mmm]枚金币卖给你，怎么样？"

translate schinese_rewrite Sebas_Shopping_Loop_f7ffc5b5:
    ...
    s "这是奥利收藏的东西。他已经卖掉大部分了，不过这个嘛……室友，你一定得买下这件火焰法术，只要 [selected_shopItem.value] 枚金币！"
...
translate schinese_rewrite Sebas_Shopping_Loop_eaa71874:
    ...
    s "这瓶体力药剂是莫肯省最有才华的药剂师亲手制作的！只要 [selected_shopItem.value] 枚金币！"
...
translate schinese_rewrite Sebas_Shopping_Loop_58df1838:
    ...
    s "我珍爱的奥利亲手做的，他说这种药膏能清除你所有的负面效果……现在只要 [selected_shopItem.value] 枚金币。"

translate schinese_rewrite Sebas_Shopping_Loop_66a9bb78:

    # s "Ahhh... if you have an axe to grind, it's probably the best one out there, no lie. And only [selected_shopItem.value] for you!"
    s "啊……要是你正想找把斧头来解决问题，这把大概就是外面最好的，绝不骗你。只要 [selected_shopItem.value] 枚金币！"

translate schinese_rewrite Sebas_Shopping_Loop_d3f1cb46:
    ...
    s "嘿！这是我的小挂饰！现在只要 [selected_shopItem.value] 枚金币！要是你想带着这个可爱的我去进行你的小冒险的话！"

translate schinese_rewrite Sebas_Shopping_Loop_2533c1b6:
    ...
    s "哈，这件是我从镇上最有名的商人那里买来的，贵得很。不过……给我最喜欢的老铁，[mmm]枚金币卖你。"

translate schinese_rewrite Sebas_Shopping_Loop_6a64b453:
    ...
    s "让我告诉你个秘密，这把弓和许多其他弓一样，都附带箭矢。所以再也不用担心忘记买箭啦！只要[mmm]枚金币！"

translate schinese_rewrite Sebas_Shopping_Loop_4a743674:
    ...
    s "这把巨剑对我来说有点太重了，带在身边不太方便，不过我想你应该拿得动，室友。给你只要[mmm]枚金币！"
...
translate schinese_rewrite Sebas_Shopping_Loop_c7bcbeb6:
    ...
    s "室友，雷希姆在我们刚才投票后专门为你量身定做了这件东西，不过他把它送给你时好像有点闹脾气……所以你还是直接从我这里买吧，只要[mmm]枚金币！"
...
translate schinese_rewrite Sebas_Shopping_Loop_0d494bca:
    ...
    s "这就是我们从河里捡到的石头！还记得吗？[e]，我想我可以把它给你……现在买的话，就收你[selected_shopItem.value]枚金币！"

translate schinese_rewrite Sebas_Shopping_Loop_bd8065c8:
    ...
    s "这瓶药剂过期了没有……我也不确定。它们看起来都一样，不过你可得格外小心，尤其是在遇到危险的时候。收你[selected_shopItem.value]枚金币怎么样？"

translate schinese_rewrite Sebas_Shopping_Loop_4ff2fe82:

    # s "Where did you find this potion, is this mine? Hmm... I think you can get [selected_shopItem.value] from this one."
    s "你从哪儿找到的这瓶药剂，这是我的吧？唔……我觉得这瓶可以收你[selected_shopItem.value]枚金币。"

translate schinese_rewrite Sebas_Shopping_Loop_3f40758f:

    # s "I see what you're doing... selling beer to me. No I won't get drunk on work... b-but how about [selected_shopItem.value] gold?"
    s "我知道你想干什么……居然想把啤酒卖给我。我才不会在工作时喝醉……但、但是收你[selected_shopItem.value]枚金币怎么样？"

translate schinese_rewrite Sebas_Shopping_Loop_a5530bbf:

    # s "That's... my key! You can't be selling that... to me?"
    s "那是……我的钥匙！你不会连我的东西都要卖回给我吧……？"
...
translate schinese_rewrite Sebas_Shopping_Loop_cb535884:
    ...
    s "[selected_shopItem.value]枚金币。给你一条建议：跳下去时用水桶，可以避免坠落伤害……等等……我们这里根本没有坠落伤害。"

translate schinese_rewrite Sebas_Shopping_Loop_dc4d1d37:

    # s "Wasn't this what you were putting on...? You must got really desperate to sell your loincloth out like that, buddy."
    s "这不是你原本要穿的吗……？老兄，你肯定是穷到连兜裆布都要拿出来卖了。"

translate schinese_rewrite Sebas_Shopping_Loop_801c5dae:

    # s "Hmm... it was your sword! Must've gotten a new favourite I suppose? [selected_shopItem.value] gold to you!"
    s "嗯……这是你原来那把剑！看来你肯定又找到新欢了？收你[selected_shopItem.value]枚金币！"

translate schinese_rewrite Sebas_Shopping_Loop_2276a9a4:

    # s "That's my Lion Charm... [selected_shopItem.value] gold... You don't want to take me with you again?"
    s "那是我的狮子护符……[selected_shopItem.value]枚金币……你不想再带我一起走了吗？"

translate schinese_rewrite Sebas_Shopping_Loop_2e3fe7f1:
    ...
    s "一本讲各种草的书？我家那位大个子奥利要是能拿到这本，肯定高兴坏了。就收你[selected_shopItem.value]枚金币！"

translate schinese_rewrite Sebas_Shopping_Loop_08001557:

    # s "I like this one! Some slimy balls, how about [selected_shopItem.value] gold?"
    s "我喜欢这个！几颗黏糊糊的球，收你[selected_shopItem.value]枚金币怎么样？"

translate schinese_rewrite Sebas_Shopping_Loop_a310eeee:

    # s "Where did you find... Nevermind. You always get your hand on anyone, even the goats. [selected_shopItem.value] gold?"
    s "你从哪儿弄到的……算了，别说了。你总是对谁都毛手毛脚的，连山羊都不放过。收你[selected_shopItem.value]枚金币？"

translate schinese_rewrite Sebas_Shopping_Loop_29101fda:

    # s "Uh... a minotaur? That's not milk! I- I can take that for [selected_shopItem.value] gold, maybe."
    s "呃……弥诺陶洛斯？那可不是牛奶！我、我可以收下这个……[selected_shopItem.value]枚金币，怎么样？"

translate schinese_rewrite Sebas_Shopping_Loop_2609c232:
    ...
    s "这个我以前没见过，实在太古老了，不在我的收藏范围内。也许我可以用[selected_shopItem.value]枚金币收下？怎么样？"

translate schinese_rewrite Sebas_Shopping_Loop_d7b0b825:
    ...
    s "你从农场拿来的？通常农场拿去集市卖的东西我可不收。不过这个我可以收，[selected_shopItem.value]枚金币！"

translate schinese_rewrite Sebas_Shopping_Loop_2d18a2b3:
    ...
    s "嘿！原来那些绿叶都跑到这里来了。我还以为我把它弄丢了。是那个老奥利给你的吧？我猜是这样。这个值[selected_shopItem.value]枚金币。"

translate schinese_rewrite Sebas_Shopping_Loop_1d31c630:

    # s "You wanna sell this thing to me? Probably worth [selected_shopItem.value] in the market."
    s "你想把这东西卖给我？它在市场上大概值[selected_shopItem.value]枚金币。"

translate schinese_rewrite Sebas_Shopping_Loop_af57d61c:

    # s "Okie Dokie! Thank you for your [selected_shopItem.name!t]! Mister [e]. Here's your [selected_shopItem.value]."
    s "好嘞！谢谢你的[selected_shopItem.name!t]！[e]先生，这是[selected_shopItem.value]枚金币。"

translate schinese_rewrite Sebas_Shopping_Loop_4d9dc5c6:

    # s "Alrighty! Thank you for your [selected_shopItem.value] gold! Mister [e]. Here's your [selected_shopItem.name!t]."
    s "好的！谢谢你的[selected_shopItem.value]枚金币！[e]先生，这是您的[selected_shopItem.name!t]。"

translate schinese_rewrite Gwyddyon_Shopping_0eb295fc:
    ...
    g "你自己看看吧，这些可是这里最精美的饰品和咒语了，我这儿也有些零零碎碎的东西。"

translate schinese_rewrite Gwyddyon_Shopping_Loop_8bc0e9d3:
    ...
    g "你最好相信我，这件[ttt!t]可是专门为渴求法力的山羊打造的，而它们正要把最后几件也抢走！现在只要[mmm]枚金币，当然是限时优惠。"

translate schinese_rewrite Gwyddyon_Shopping_Loop_9cebefc3:

    # g "Believe it or not, you can get this [ttt!t] for only [mmm] gold. One time offer."
    g "不管你信不信，只要[mmm]枚金币就能买到这个[ttt!t]。一次性优惠。"

translate schinese_rewrite Gwyddyon_Shopping_Loop_5f0c8525:

    # g "That's not my specialty, but I say this [ttt!t] is worth... [mmm] gold, probably."
    g "这不是我的专长，不过我觉得这个[ttt!t]大概值……[mmm]枚金币。"
...
translate schinese_rewrite Gwyddyon_Shopping_Loop_fb4526d8:
    ...
    g "还有什么能比每回合恢复5点MP的法杖更厉害？{size=20}没有。{/size}而且你甚至不需要给它充能，谁能想到呢！{size=20}反正我没想到。{/size}{p}[mmm]枚金币，这最后一件就是你的了。"
...
translate schinese_rewrite Gwyddyon_Shopping_Loop_2a750d15:
    ...
    g "那么，这个[ttt!t]卖你[mmm]枚金币如何？显然，这是品质最好的货。"

translate schinese_rewrite Gwyddyon_Shopping_Loop_651f367a:
    ...
    g "想增强你的魔法造诣吗？快来看看这些精美的水晶宝石吧。这是我运用它们能量的得意之作之一，现在只要[mmm]枚金币。"
...
translate schinese_rewrite Gwyddyon_Shopping_Loop_8fc4508f:
    ...
    g "苦薄荷。这东西能驱赶我们聚落附近的某个邻居。不，不是卢斯特菲尔德。你应该去那边、靠近那群蠢货的地方弄一些，或者花[mmm]枚金币买点。"
...
translate schinese_rewrite Gwyddyon_Shopping_Loop_0cb66860:
    ...
    g "这个？不过是覆盖着水晶碎片的肠线而已——什么？你不知道内脏是什么……？咳……嗯，你不需要知道。总之，这些要[mmm]枚金币。"

translate schinese_rewrite Gwyddyon_Shopping_Loop_d290fb34:
    ...
    g "上好的布料，非常耐用。不管你信不信，这种布料在高塔里的贵族和有钱人之间很受欢迎，是真的。我们可以用[mmm]枚金币卖给你。"

translate schinese_rewrite Gwyddyon_Shopping_Loop_875452c5:
    ...
    g "起初，人们把这种树叫作桤木，但后来不知什么时候，有人把自己的经历投射进了树名里。真是场悲剧……嗯，也许你也想花[mmm]枚金币买一些？"

translate schinese_rewrite Gwyddyon_Shopping_Loop_2c65202d:
    ...
    g "多年前，藤蔓曾很受欢迎，人们常用它们装饰房屋。但随着时间推移，它们长出了原本该生长的地方，很快就对房屋构成了危险，于是人们为此大惊小怪。慰问与祈祷，再加上[mmm]枚金币。"

translate schinese_rewrite Gwyddyon_Shopping_Loop_63432e0c:

    # g "You want this [ttt!t]? I can do [mmm] gold."
    g "你想要这个[ttt!t]？我可以收你[mmm]枚金币。"

translate schinese_rewrite Gwyddyon_Shopping_Loop_97c62b8c:
    ...
    g "想重置你学会的所有技能吗？这瓶药剂正好能做到。我亲手把几颗宝石碾碎，调制成了这瓶无比顺滑的药剂。制作起来相当昂贵，所以我只能以[mmm]枚金币卖给你一瓶。"

translate schinese_rewrite Gwyddyon_Shopping_Loop_f1780300:
    ...
    g "这本书是不久前才卖到我手里的。卖家说它有助于你的治疗能力，也许和我的水晶有些共通之处。不管怎么说，给我[mmm]枚金币，它就是你的了。"

translate schinese_rewrite Gwyddyon_Shopping_Loop_5a80a299:

    # g "After the two dimwits came back from the cave, one of them, the general came and dropped his little spell book here."
    g "那两个蠢货从洞穴回来后，其中一个，也就是将军，过来把他那本小法术书落在了这里。"

translate schinese_rewrite Gwyddyon_Shopping_Loop_6f08bf96:
    ...
    g "他说了些类似“给信使留个法术”之类的话。呵，他甚至没告诉你，对吧？那么，给我[mmm]枚金币，它就是你的了。"

translate schinese_rewrite Gwyddyon_Shopping_Loop_c2f3fedd:
    ...
    g "我不知道这东西是从哪儿来的，但它是本很适合火焰法师的法术书。我想狮子那里卖的一本书，能和它完美搭配。那么，你愿意花[mmm]枚金币买下这个法术吗？"

translate schinese_rewrite Gwyddyon_Shopping_Loop_ecc4b476:
    ...
    g "想满足你永无止境的求知欲吗？这个[ttt!t]正适合你！只要[mmm]枚金币，而且只有这里才有卖！{size=15}我觉得是这样。{/size}"

translate schinese_rewrite Gwyddyon_Shopping_Loop_c1582fa7:

    # g "Let's see. I say it's at most [mmm] gold, do you wanna sell this [ttt!t]?"
    g "让我看看。我觉得它最多值[mmm]枚金币，你想卖掉这个[ttt!t]吗？"

translate schinese_rewrite Gwyddyon_Shopping_Loop_de9b97e5:

    # g "Uhm? Is this from the rune guardians? Condolences. I can buy this hand for [mmm] gold now."
    g "嗯？这是符文守护者的东西？节哀。我现在可以出[mmm]枚金币买下这只手。"

translate schinese_rewrite Gwyddyon_Shopping_Loop_4f5a0197:
    ...
    g "我能感受到这块石头残留的庞大力量，它仍散发着微弱的魔法气息……那并非这块石头固有的力量。给我[mmm]枚金币，我就好好研究一下这块石头。"

translate schinese_rewrite Gwyddyon_Shopping_Loop_2aa453a9:

    # g "Doesn't look too bad. Though, you should probably keep this [ttt!t] for yourself, but I can buy it for [mmm] gold."
    g "看起来不算太糟。不过，你最好还是把这个[ttt!t]留给自己，但我可以出[mmm]枚金币买下它。"

translate schinese_rewrite Gwyddyon_Shopping_Loop_464acfb2:

    # g "Could be useful, I think. How about [mmm] gold and I'll keep this [ttt!t] for you."
    g "我觉得可能有用。给我[mmm]枚金币，我就替你保管这个[ttt!t]，如何？"

translate schinese_rewrite Gwyddyon_Shopping_Loop_26d06432:
    ...
    g "你说这是精华？真没想到像你这样的人居然能驯服弥诺陶洛斯，不过我又知道些什么呢。它们的精华相当神秘，也许我能花[mmm]枚金币买到一瓶？"

translate schinese_rewrite Gwyddyon_Shopping_Loop_a59ed0ff:
    ...
    g "最近经常在洞穴里活动，和里面混熟了吗？我可以出[mmm]枚金币。这些东西对我的水晶装备和小玩意儿会很有用。"

translate schinese_rewrite Gwyddyon_Shopping_Loop_9b079d01:

    # g "Not a specialist, but I can probably go for... [mmm] gold for this [ttt!t]."
    g "我不算行家，不过这个[ttt!t]大概能出价……[mmm]枚金币。"

translate schinese_rewrite Gwyddyon_Shopping_Loop_db0e8123:
    ...
    g "呃，你想卖这本书？你在哪儿找到的——算了，不重要。这书泡在史莱姆汁里有一阵子了，我最多只能给[mmm]枚金币。"

translate schinese_rewrite Gwyddyon_Shopping_Loop_1c8f6949:

    # g "This [ttt!t] seems promising. I can get you [mmm] gold for that."
    g "这个[ttt!t]看起来挺有价值。我可以给你[mmm]枚金币。"

translate schinese_rewrite Gwyddyon_Shopping_Loop_9cb1baca:

    # g "It was a great bargain, [e]. Thanks for the [mmm] gold and here's your [ttt!t]."
    g "真是笔划算的买卖，[e]。谢谢你的[mmm]枚金币，这是你的[ttt!t]。"

translate schinese_rewrite Gwyddyon_Shopping_Loop_28a63adc:

    # g "Mmmph. That can be useful. Here's the [mmm] gold for your [ttt!t]."
    g "唔。这东西可能有用。这是买你[ttt!t]的钱：[mmm]枚金币。"

translate schinese_rewrite Methis_Shopping_ea62ce2b:

    # m "Take a look, here's our finest collections in the shop."
    m "来看看，这是我们店里最好的藏品。"

translate schinese_rewrite Methis_Shopping_Loop_f11cab7f:
    ...
    m "这可是雪地之外很罕见的草药。用它来教训那些还没觉得够冷的混蛋熊，总是个好法子。要不[mmm]枚金币？"

translate schinese_rewrite Methis_Shopping_Loop_c5ca73b2:
    ...
    m "就一块冰，完全没用。说实话，我只是拿它填空货架的，也不知道你为什么想要它，不过买一块得花[mmm]枚金币。"

translate schinese_rewrite Methis_Shopping_Loop_9fad9928:

    # m "Alright, this sounds like an opportunity to learn, for [mmm] gold."
    m "好吧，听起来是个学习的机会，售价[mmm]枚金币。"

translate schinese_rewrite Methis_Shopping_Loop_eaefdcc0:
    ...
    m "你称作……生命药水的东西，我们这儿叫雪莓。这种东西在雪林里很容易找到，那白色、黏稠又多汁的质地，总让我想起很多东西。每个[mmm]枚金币。"

translate schinese_rewrite Methis_Shopping_Loop_8ac7ad31:
    ...
    m "看，这是只对自己的魅惑有信心的人才知道的秘密。这尊神像是用来对付无法魅惑的怪物的，也该学点新招了。这个要[mmm]枚金币。"

translate schinese_rewrite Methis_Shopping_Loop_f3f0fb03:
    ...
    m "据说，曾赐福于雪域的神明奥科手里曾有许多斧头。大多数都不卖，不过这把嘛……有点生锈，我可以[mmm]枚金币卖给你。"

translate schinese_rewrite Methis_Shopping_Loop_acb664bc:
    ...
    m "只是一把小铲子，花[mmm]枚金币，说不定能挖出这附近的一些植物——只要它还没被埋在雪里。"

translate schinese_rewrite Methis_Shopping_Loop_8dc4077b:

    # m "[mmm] Gold, and this last one is yours."
    m "[mmm]枚金币，这最后一件就是你的了。"

translate schinese_rewrite Methis_Shopping_Loop_ccca213e:

    # m "Is this the work of a famous potion maker in the South? Looks... drinkable. I'll take this for [mmm]."
    m "这是南方那位著名药剂师的作品？看起来……能喝。我愿意用[mmm]枚金币买下它。"

translate schinese_rewrite Methis_Shopping_Loop_2448bc22:

    # m "Ah, classic mana potion made for magic users. How about [mmm] gold for this one?"
    m "啊，给魔法使用者制作的经典法力药水。这瓶[mmm]枚金币，怎么样？"

translate schinese_rewrite Methis_Shopping_Loop_3a87a57d:

    # m "I don't drink on work... it makes your mind go dizzy, b-but how about [mmm] gold?"
    m "我工作时不喝酒……会让脑子发晕，不过、不过[mmm]枚金币怎么样？"

translate schinese_rewrite Methis_Shopping_Loop_85310b95:

    # m "This one... it looks important. I can't take this from you... can I? [mmm] gold... maybe?"
    m "这个……看起来很重要。我不能从你手里拿走它……对吧？[mmm]枚金币……怎么样？"

translate schinese_rewrite Methis_Shopping_Loop_fae8a3fb:

    # m "Ah, smells just like it's worn yesterday. Give it to me and I'll make good use of it. And [mmm] gold for you!"
    m "啊，闻起来就像昨天才穿过一样。给我吧，我会好好利用它。再给你[mmm]枚金币！"

translate schinese_rewrite Methis_Shopping_Loop_0b41fddb:

    # m "Looks like a good learning experience, I can take this for [mmm] gold."
    m "看起来是个不错的学习机会，我可以用[mmm]枚金币收下它。"

translate schinese_rewrite Methis_Shopping_Loop_a89703aa:

    # m "A piece of Coal? We mined this every day, don't tell me you stole from the carts outside... But how about... [mmm] gold."
    m "一块煤？我们天天都挖这个，别告诉我你是从外面的矿车上偷来的……不过……[mmm]枚金币怎么样。"

translate schinese_rewrite Methis_Shopping_Loop_0891deac:

    # m "Ah, the flower of bears, they love this even though it doesn't grow much in snow. I'll take this for [mmm] gold."
    m "啊，熊之花。它们很喜欢这种花，尽管这种花在雪地里不怎么生长。我愿意出[mmm]枚金币买下它。"

translate schinese_rewrite Methis_Shopping_Loop_93a9b389:

    # m "Hmm... this looks like it can sell for [mmm] gold."
    m "嗯……这东西看起来能卖[mmm]枚金币。"

translate schinese_rewrite Methis_Shopping_Loop_f515f207:

    # m "Thanks for the [ttt!t], and the [mmm] gold is yours now."
    m "谢谢你的[ttt!t]，[mmm]枚金币现在归你了。"

translate schinese_rewrite Methis_Shopping_Loop_2106fad4:

    # m "Nice, this [ttt!t] is now owned by you, young one. And thanks for the [mmm] gold."
    m "不错，这件[ttt!t]现在归你了，小家伙。也谢谢你的[mmm]枚金币。"
