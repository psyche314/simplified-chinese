translate schinese_rewrite slime_battle_ffc0301b:

    # "You are facing a green slime, it is slowly slithering at you. You raise your fists, ready to strike at the gelatinous mass."
    "你正面对着一只绿色史莱姆，它正慢慢向你蠕动。你握紧双拳，准备朝这团胶状粘液发起攻击。"

translate schinese_rewrite slime_battle_ca207437:

    # "You are facing a green slime, it is slowly slithering at you. you pull out your [pc.weapon.name!t]."
    "你正面对着一只绿色史莱姆，它正慢慢向你蠕动。你拔出了[pc.weapon.name!t]。"

translate schinese_rewrite slime_battle_loop_d8637daa:

    # "Slime lunges forward and slams into your waist with its gelatinous body. Your health decreases by [enemy_damage] HP."
    "史莱姆猛地向前冲来，用胶质身体狠狠撞向你的腰部。你的生命值减少了[enemy_damage]点。"

translate schinese_rewrite slime_battle_loop_c030a39e:
    ...
    "史莱姆向你蠕动而来，将你困在它的身体里。你挣扎了几秒，才从史莱姆体内脱身。你的生命值减少了[enemy_damage]点。"

translate schinese_rewrite slime_win_2e14fb9c:
    ...
    "你打出最后一拳后，将手臂从史莱姆身上抽回。史莱姆慢慢停止了所有动作，融入草地，形成一滩绿色的黏液。"

translate schinese_rewrite slime_win_670fb81f:
    ...
    "你将[pc.weapon.name!t]从史莱姆体内抽出，完成了最后一击。史莱姆慢慢停止了所有动作，融入草地，形成一滩绿色的黏液。"
...
translate schinese_rewrite slime_win_65828eaf:
    ...
    "你在史莱姆周围搜寻时，发现了一个[slimeball_item.name]、一个[slimecrystal_item.name]和[exp_drop]点经验！"
...
translate schinese_rewrite slime_win_63f71357:
    ...
    "你在史莱姆周围搜寻时，发现了一个[slimeball_item.name]和[exp_drop]点经验！"
...
translate schinese_rewrite slime_lose_faae127b:
    ...
    "你踉跄了一下，双膝发软，面对这团黏稠的史莱姆几乎无法喘息。不出所料，你倒在草地上，紧紧抓住体内最后一丝力气。"

translate schinese_rewrite slime_lose_b2fedee8:

    # msg "Do you wish to replay the losing Scene?" nointeract
    msg "你想重放战败场景吗？" nointeract

translate schinese_rewrite slime_lose_f2930421:

    # "You fall unconscious shortly after..."
    "你很快就失去了意识……"

translate schinese_rewrite slime_lose_e8695ea9:

    # "Its goo runs over your body, soaking up your scent with the viscous chemicals."
    "它的黏液流过你的身体，粘稠的化学物质吸收了你的气味。"

translate schinese_rewrite slime_lose_9b3760c2:

    # "Maybe it'll be a bad idea if you ever lose to the creature once again..."
    "看来下次再输给这东西可不是什么好事……"

translate schinese_rewrite slime_lose_38f4471d:
    ...
    "醒来时，你发现史莱姆已经不见了。你的胯部周围仍有一滩滩黏液残留。"

translate schinese_rewrite slime_lose_1b576833:
    ...
    "你不愿再回想那件事，于是迅速起身，拍掉生殖器周围的黏液，离开了这里。"

translate schinese_rewrite dummy_battle_0d373686:

    # "You are facing the practice dummy, it is waving at you, getting ready for you to begin."
    "你正面对着训练人偶，它正朝你挥手，准备等你开始。"

translate schinese_rewrite dummy_battle_loop_4da3d7f0:

    # "You get closer to let the dummy slap you on the side. Your health decreases by [enemy_damage] HP."
    "你靠近一些，任由人偶拍向你的侧身。你的生命值减少了[enemy_damage]点。"

translate schinese_rewrite dummy_win_b0ed8c92:

    # "When you finish your last strike on the dummy, it crosses its arm, signaling its defeat."
    "你对人偶打出的最后一击结束后，它交叉双臂，示意自己已经落败。"

translate schinese_rewrite dummy_win_2d72b297:

    # "The dummy hands you 3 [patch_item.name!t], and [exp_drop] EXP!"
    "人偶递给你3块[patch_item.name!t]，以及[exp_drop]点经验！"

translate schinese_rewrite dummy_win_91d73317:

    # "The dummy hands you a [patch_item.name!t], and [exp_drop] EXP!"
    "人偶递给你一块[patch_item.name!t]，以及[exp_drop]点经验！"

translate schinese_rewrite dummy_lose_5c5fd169:
    ...
    "你的生命值降至0，疲惫得几乎要倒在草地上。世界连同一动不动的人偶一起，慢慢淡去。"

translate schinese_rewrite dummy_lose_c4214a99:
    ...
    "醒来后，你检查了口袋，发现没有任何东西丢失。你看见那个人偶桩仍立在巷子里，正朝你挥手，似乎在嘲笑一个竟然输给人偶的人。"

translate schinese_rewrite goathuntsman_battle_790cd1c4:
    ...
    "你正面对着山羊猎人，他傲慢地挥舞着长矛，挑衅你靠近。你握紧双拳，摆出了格斗姿态。"

translate schinese_rewrite goathuntsman_battle_8aed4d60:
    ...
    "你正面对着山羊猎人，他傲慢地挥舞着长矛，示意你靠近。你手持[pc.weapon.name!t]进行防御。"

translate schinese_rewrite goathuntsman_battle_loop_61edf8e6:
    ...
    "山羊猎人朝你挥矛，你来不及躲开这一击。你的生命值减少了[enemy_damage]点。"

translate schinese_rewrite goathuntsman_battle_loop_43de825b:

    # "The goat charges at you, hitting you with a kick to the chest. Your health decreases by [enemy_damage] HP."
    "山羊冲向你，一脚踢中你的胸口。你的生命值减少了 [enemy_damage] 点。"

translate schinese_rewrite goathuntsman_battle_loop_3aa72489:

    # "The goat huntsman swings his spear towards you. You managed to deflect his spear and dodge the attack."
    "山羊猎人挥矛刺向你，你成功挡开他的长矛，躲过了这一击。"

translate schinese_rewrite goathuntsman_battle_loop_ef141914:

    # "The goat charges at you, trying to kick at your chest, but you block the blow and push him back."
    "山羊冲向你，试图踢向你的胸口，但你挡住了这一击，将他推了回去。"

translate schinese_rewrite goathuntsman_battle_loop_99a4ba86:

    # "While you are calculating your next move, you fall into his trap, your dodges are now reduced by half for 3 rounds."
    "你一边盘算着下一步行动，一边落入了他的陷阱，闪避能力降低了一半，持续 3 回合。"

translate schinese_rewrite goathuntsman_battle_loop_be0bd1c6:
    ...
    "山羊猎人抓了抓遮裆布，又将两根手指横在胯间，透过布料描摹着阳具的形状。"

translate schinese_rewrite goathuntsman_battle_loop_66bf829c:

    # gt "You thirsty? Surrender to me and maybe you'll have the best time of your life."
    gt "口渴了吗？向我投降吧，说不定我会让你体验到这辈子最美妙的感觉。"

translate schinese_rewrite goathuntsman_battle_loop_eeaaf87f:
    ...
    "你咽了咽口水，面对他的诱惑，你无疑已经兴奋到了极点，脑中想着他的阳具会是什么味道。你的性欲增加了 [enemy_flirt] 点。"

translate schinese_rewrite goathuntsman_battle_loop_fc6ce626:
    ...
    "猎人伸展着身体，炫耀自己强壮的体格；你看得出来，他柔软的胸膛几乎要在你面前隆起。"

translate schinese_rewrite goathuntsman_battle_loop_6ae49468:

    # gt "You see how strong of a specimen I am. Come closer to get a better look!"
    gt "看到了我有多强壮吗？不妨再靠近些，好好看个够！"

translate schinese_rewrite goathuntsman_battle_loop_21bad776:
    ...
    "他那迷人的肌肉让你目瞪口呆，你的思绪不禁飘向他进入你体内的种种想象。你的性欲增加了 [enemy_flirt] 点。"

translate schinese_rewrite goathuntsman_battle_loop_be0bd1c6_1:

    # "The goat scratches at his loincloth, he put two of his fingers across his crotch, tracing the shape of his cock through the fabric."
    "山羊猎人抓了抓遮裆布，又将两根手指横在胯间，透过布料描摹着阳具的形状。"

translate schinese_rewrite goathuntsman_battle_loop_66bf829c_1:
...
translate schinese_rewrite goathuntsman_battle_loop_6ae49468_1:

    # gt "You see how strong of a specimen I am. Come closer to get a better look!"
    gt "看到了我有多强壮吗？不妨再靠近些，好好看个够！"

translate schinese_rewrite goathuntsman_battle_loop_969a6d77:
    ...
    "他对你性欲的诱惑似乎失败了。你站在那里，等着他结束挑衅。你们谁也不会再提起这件事。"

translate schinese_rewrite goathuntsman_win_ead1256b:

    # "You strike the huntsman for the last time, before he falls on the ground. Luckily he is still breathing."
    "你最后一次击中了猎人，他随即倒在地上。所幸他还在呼吸。"

translate schinese_rewrite goathuntsman_win_09d31458:

    # "The goat huntsman cannot stop himself from stroking his cock. He lies on the ground, surrendering himself at your will."
    "山羊猎人忍不住抚摸自己的阳具。他躺在地上，任由你摆布。"

translate schinese_rewrite goathuntsman_win_36785ac5:

    # gt "P-please... I...w-want... c-cock, m-make me... cum."
    gt "请、请……我、我想要……鸡、鸡巴……让、让我射出来……"

translate schinese_rewrite goathuntsman_win_e7908e8a:

    # k "...Well. The second one, or should I say, ones. They're our best duo in the tribe... B-best warrior duo..."
    k "……嗯。第二个，不，应该说是两个人。他们是部落里最棒的一对……最、最棒的战士搭档……"

translate schinese_rewrite goathuntsman_win_534b91e8:

    # gt "W-wait... not here..."
    gt "等、等等……别在这里……"

translate schinese_rewrite goathuntsman_win_c7f00f96:

    # "The goat looks at you with the pleading eyes... you decide to bring him to the forest..."
    "山羊用恳求的目光望着你……你决定把他带到森林里……"

translate schinese_rewrite goathuntsman_win_a20cefa7:

    # "..."
    "……"

translate schinese_rewrite goathuntsman_win_a321a1c0:

    # "As much as you wish to relieve all your pent up anger on the poor goat, you decide against it."
    "尽管你很想把积攒已久的怒火全都发泄在这只可怜的山羊身上，但你还是决定不这么做。"

translate schinese_rewrite goathuntsman_win_a321a1c0_1:

    # "As much as you wish to relieve all your pent up anger on the poor goat, you decide against it."
    "尽管你很想把积攒已久的怒火全都发泄在这只可怜的山羊身上，但你还是决定不这么做。"

translate schinese_rewrite goathuntsman_win_a7afff52:

    # "As you search around the huntsman, you find a Cashmere Wool, a Pocket Bell and [exp_drop] EXP!"
    "你搜查猎人周身，找到了一团羊绒毛、一个袖珍铃铛和[exp_drop]点经验！"

translate schinese_rewrite goathuntsman_win_39f8bdce:

    # "As you search around the huntsman, you find a Cashmere Wool and [exp_drop] EXP!"
    "你搜查猎人周身，找到了一团羊绒毛和[exp_drop]点经验！"

translate schinese_rewrite goathuntsman_win_1bdeeefc:

    # "You also filch [found_gold] gold from the huntsman's loincloth. You pick the coins up, and put them in your pouch."
    "你还从猎人的缠腰布里偷走了[found_gold]枚金币。你捡起金币，将它们装进了自己的钱袋。"

translate schinese_rewrite goathuntsman_win_237c5265:

    # "You leave the huntsman alone in the forest, he will probably wake up in a few hours."
    "你把猎人独自留在森林里，他大概几小时后就会醒来。"

translate schinese_rewrite goathuntsman_win_daa1fe17:

    # gt "...well. Good job."
    gt "……嗯。干得不错。"

translate schinese_rewrite goathuntsman_win_37055e34:

    # "You leave the huntsman still panting profusly on the side of the training ground..."
    "你把猎人留在训练场边，他仍在大口喘息……"

translate schinese_rewrite goathuntsman_win_91f1d522:

    # msg "You are now Level [pc.level]! Check your inventory to allocate your level points."
    msg "你现在是[pc.level]级！查看背包，分配你的升级点数。"

translate schinese_rewrite goathuntsman_lose_6b17550b:
    ...
    "你还在拼命挣扎，但已经耗尽了所有力气。他像猎人俯视猎物般站在你上方，舔着嘴唇，思考着下一步行动。"

translate schinese_rewrite goathuntsman_lose_a6e8bfd7:

    # "You fall to your knees, your hands all over your body, you cannot resist your lust..."
    "你跪倒在地，双手抚遍全身，无法抗拒自己的欲望……"

translate schinese_rewrite goathuntsman_lose_85500e57:

    # "The huntsman stands above you like a hunter with his prey, licking his lips while thinking about his next move."
    "猎人站在你上方，像猎人俯视猎物般居高临下地舔了舔嘴唇，思考着下一步行动。"

translate schinese_rewrite goathuntsman_lose_f879780c:

    # gt "Heh... gotta bring you to somewhere discreet..."
    gt "嘿……得把你带到隐蔽点的地方……"

translate schinese_rewrite goathuntsman_lose_7489b947:

    # "The goat carries you out of the goat tribe..."
    "山羊把你带出了山羊部落……"

translate schinese_rewrite goathuntsman_lose_16204aa1:

    # "You fall unconscious soon after..."
    "没过多久，你便失去了意识……"

translate schinese_rewrite goathuntsman_lose_ef167cc4:
    ...
    "几小时后，你醒了过来，身体依旧酸痛。猎人不知所踪，你的部分金币也随之消失了。"

translate schinese_rewrite buggbear_battle_393e2992:
    ...
    "你正面对着一头野生熊地精。他的眼中燃烧着怒火，脸上明摆着一副恨不得用狼牙棒砸碎你脑袋的样子。"

translate schinese_rewrite buggbear_battle_loop_4716fc18:

    # "You cann't use the Sedative yet, the buggbear is too responsive... Perhaps you need to make him weaker, or hornier..."
    "熊地精反应太灵敏了，还不能使用镇静剂……也许你得先让他更虚弱，或者更饥渴……"
...
translate schinese_rewrite buggbear_battle_loop_6c9ae8fe:
    ...
    "熊地精挥舞狼牙棒朝你砸来，你勉强拨开沉重的狼牙棒，躲过了这一击。"

translate schinese_rewrite buggbear_battle_loop_bd492e8b:

    # "The buggbear charges at you, trying to kick your chest, but you block the blow and push him back."
    "熊地精冲过来，试图踢你的胸口，但你挡住了这一脚，将他推了回去。"

translate schinese_rewrite buggbear_battle_loop_d7196aa4:
    ...
    "熊地精举起左拳，吟唱着部族的战歌。在这场战斗剩余的时间里，他的攻击伤害增加10点。"

translate schinese_rewrite buggbear_sedated_84d8db4c:

    # "You throw your sedative powder right into the buggbear's face, hitting him in the nose."
    "你把镇静粉末直撒向熊地精的脸，正中他的鼻子。"
...
translate schinese_rewrite buggbear_sedated_e3ae465d:
    ...
    "怪物狠狠吸了一大口粉末，随后才意识到那是什么东西。"

translate schinese_rewrite buggbear_sedated_2e89c57b:

    # "Your sedative definitely worked, as he coughs violently, his limbs growing weaker."
    "镇静剂果然起效了，他剧烈地咳嗽起来，四肢也越来越无力。"

translate schinese_rewrite buggbear_sedated_4454de5d:

    # "He staggers for a few seconds before growling back at you, and collapses in front of your weapon."
    "他踉跄了几秒，朝你低吼一声，便倒在你的武器前。"

translate schinese_rewrite buggbear_sedated_a20cefa7:

    # "..."
    "……"

translate schinese_rewrite buggbear_sedated_3c2ecbab:

    # "After it falls flat, you walk towards the buggbear, and poke him with your wooden stick."
    "待它瘫倒，你走向熊地精，用手中的木棍戳了戳他。"

translate schinese_rewrite buggbear_sedated_745d7195:

    # "You take a while to actually confirm that he is indeed knocked out, and begin taking out an empty bottle from your bag."
    "你花了一会儿才确认他确实已经昏迷，随后开始从包里取出一个空瓶。"
...
translate schinese_rewrite buggbear_sedated_7baafefa:
    ...
    "你把手举到昏迷的熊地精上方；他这下肯定睡熟了。"

translate schinese_rewrite buggbear_sedated_d291c900:

    # "Without waking up the monster, you gently lower his chin and open his mouth."
    "为了不惊醒这个怪物，你轻轻压低他的下巴，掰开他的嘴。"

translate schinese_rewrite buggbear_sedated_966e7859:

    # "His loud snore almost startled you, but you calm down and quickly scoop up the extra sticky liquid around his tongue."
    "他的鼾声又响又大，差点把你吓一跳，但你很快镇定下来，迅速收集他舌头周围多余的黏稠液体。"

translate schinese_rewrite buggbear_sedated_a20cefa7_1:

    # "..."
    "……"

translate schinese_rewrite buggbear_sedated_ed06d27d:

    # e "fuck..."
    e "操……"

translate schinese_rewrite buggbear_sedated_ae821e5b:
    ...
    "你失手掉了瓶子，他的唾液洒得你满身都是。好在熊地精似乎没有注意到你的笨拙。"

translate schinese_rewrite buggbear_sedated_8da24fa6:

    # "In a few seconds, you abruptly scrape the rest of his saliva back into the bottle and get up from the mess."
    "几秒内，你猛地把剩下的唾液刮回瓶中，从这片狼藉里站起身。"

translate schinese_rewrite buggbear_sedated_wakeup_00453886:

    # "You feel it before you understand it."
    "你先感觉到了它，才明白那是什么。"

translate schinese_rewrite buggbear_sedated_wakeup_4ef8a75f:

    # "The buggbear's snoring catches in his throat and subsides, and his lip twitches sharply against your fingers."
    "熊地精的鼾声在喉咙里一滞，随即平息；他的嘴唇贴着你的手指猛地抽动了一下。"

translate schinese_rewrite buggbear_sedated_wakeup_6dae054e:

    # "One bloodshot eye cracks open and fixes on you at once."
    "一只布满血丝的眼睛睁开一道缝，立刻盯住了你。"

translate schinese_rewrite buggbear_sedated_wakeup_d7144988:

    # "You wrench your hand away just before his claws snap shut, sending saliva splattering across his chin and your sleeve."
    "就在他的爪子猛然合拢前，你用力抽回手；唾液飞溅开来，洒在他的下巴和你的袖子上。"

translate schinese_rewrite buggbear_sedated_escape_2_59a191db:

    # "The buggbear lurches up with a furious, guttural growl, his huge body swaying as the sedative wars with his rage."
    "熊地精发出愤怒而低沉的吼声，踉跄着站起身；他庞大的身躯摇晃不定，药效正与他的怒火抗衡。"

translate schinese_rewrite buggbear_sedated_escape_2_337e3b07:

    # "Even half-drugged, the force of his swing tears through the air hard enough to make you flinch."
    "即使药效发作了一半，他挥击的力量依然撕裂空气，逼得你一阵瑟缩。"

translate schinese_rewrite buggbear_sedated_escape_2_8205455a:

    # "You throw yourself flat and scramble beneath his flailing arm while he snarls and struggles to steady his footing."
    "你猛地趴倒，慌忙从他挥舞的手臂下钻过；他一边低吼，一边挣扎着稳住脚步。"

translate schinese_rewrite buggbear_sedated_escape_3_d0f6c0cb:

    # "The bottle is slick in your trembling grip."
    "瓶子在你颤抖的手中滑腻不堪。"

translate schinese_rewrite buggbear_sedated_escape_3_466b0e5c:

    # "Behind you, the buggbear crashes through the brush with a roar, dragging his heavy body forward through sheer fury."
    "身后，熊地精怒吼着撞穿灌木，纯凭怒火拖着沉重的身躯向前冲。"

translate schinese_rewrite buggbear_sedated_escape_3_107956f9:
    ...
    "你纵身扑进灌木丛，听见熊地精在身后整个人撞上一棵树；树皮咔嚓裂响，树叶也随之纷纷飞散。"

translate schinese_rewrite buggbear_sedated_escape_3_9ec02c86:
    ...
    "等他挣脱出来时，药效再次拖住了他，把他狂怒的冲锋变成迟缓而踉跄的追赶。"

translate schinese_rewrite buggbear_sedated_escape_3_7d1481d5:

    # "That single opening is all you need to vanish into the forest."
    "这唯一的空当，足够让你消失在森林中。"

translate schinese_rewrite buggbear_sedated_escape_fail_9118a4da:

    # "You hesitate for one fatal heartbeat."
    "你致命地迟疑了一瞬。"

translate schinese_rewrite buggbear_sedated_escape_fail_40277e08:
    ...
    "熊地精在你恢复过来之前便猛冲上来，撞得你手中的瓶子脱手，旋转着飞进泥土里。"

translate schinese_rewrite buggbear_sedated_escape_fail_4b3a49d1:

    # "His hot, rancid breath crashes over your face as he realizes exactly what you were trying to do."
    "他意识到你究竟想做什么时，灼热而腥臭的气息扑面而来。"

translate schinese_rewrite buggbear_sedated_reward_1ce1f906:

    # "You do not stop running until the buggbear's enraged roars have faded into the distance."
    "你一直跑，直到熊地精愤怒的咆哮声渐渐消失在远处。"

translate schinese_rewrite buggbear_sedated_reward_4663f426:

    # "Only then do you dare look down at the bottle clenched in your hand."
    "直到这时，你才敢低头看向手中紧握的瓶子。"

translate schinese_rewrite buggbear_sedated_reward_7fe4a58a:

    # "Despite the mess and the chase, enough of the buggbear's saliva still sloshes inside to make the risk worthwhile."
    "尽管场面一片狼藉，还被熊地精追赶了一路，瓶中仍有足够的熊地精唾液在晃荡，这番冒险也算值得。"

translate schinese_rewrite buggbear_sedated_reward_8ec4a406:

    # "You have collected a bottle of buggbear saliva, you now own [item_number] bottle."
    "你收集了一瓶熊地精唾液，现在拥有[item_number]瓶。"

translate schinese_rewrite buggbear_sedated_escape_win_87247084:
    ...
    "熊地精还在身后的树林某处，你根本没机会折返回去拿走他剩下的东西。"

translate schinese_rewrite buggbear_sedated_escape_win_41407747:

    # "Still, you made it out with the saliva sample, which is more than you expected when his eyes snapped open."
    "不过，你还是带着唾液样本逃了出来，这已经超出了熊地精猛然睁眼时你的预期。"

translate schinese_rewrite buggbear_win2_67d3a7db:

    # "As you search around the buggbear, you find a Raw Meat, a Strap and [exp_drop] EXP!"
    "你搜遍熊地精全身，收获了1块生肉、1条皮带和[exp_drop]点经验值！"

translate schinese_rewrite buggbear_win2_5da6f9be:

    # "As you search around the buggbear, you find a Raw Meat and [exp_drop] EXP!"
    "你搜遍熊地精全身，收获了1块生肉和[exp_drop]点经验值！"

translate schinese_rewrite buggbear_win2_b3fe08c7:

    # "You also find [found_gold] gold in the buggbear's leather pouch. You pick the coins up swiftly."
    "你还在熊地精的皮包里发现了[found_gold]枚金币，连忙将金币捡了起来。"

translate schinese_rewrite buggbear_win2_0f838d4b:

    # "You leave the buggbear alone in the forest, he will probably wake up in a few hours."
    "你把熊地精留在森林里，他大概几小时后就会醒来。"

translate schinese_rewrite buggbear_win2_91f1d522:

    # msg "You are now Level [pc.level]! Check your inventory to allocate your level points."
    msg "你的等级已升至[pc.level]级！请查看背包，分配你的等级点数。"

translate schinese_rewrite buggbear_lose_47f40fa7:
    ...
    "你努力抵抗着熊地精，可意识还是屈服于对熊地精无法遏制的欲望。他扑向你无力反抗的身体，仿佛你是摆上餐桌的盛宴。"

translate schinese_rewrite buggbear_lose_f63e460b:
    ...
    "你努力抵抗着熊地精，可心中满是对他的无法遏制的欲望。他扑向你无力反抗的身体，仿佛你是摆上餐桌的盛宴。"

translate schinese_rewrite buggbear_lose_a20cefa7:

    # "..."
    "……"

translate schinese_rewrite mossgolem_battle_a69f0c95:

    # "It is a Moss Golem. He is standing before you, he looks enraged by your intrusion."
    "那是一尊苔藓石魔像。他正站在你面前，显然因你的闯入而怒不可遏。"

translate schinese_rewrite mossgolem_battle_374877a9:
    ...
    "你能感觉到他的蓝色光环辐射整条河流。他没有左手，断口处覆盖着层层苔藓与藤蔓。"

translate schinese_rewrite mossgolem_battle_2b8baa4d:

    # "You raise your [pc.weapon.name!t], defending yourself from the golem's attack."
    "你举起[pc.weapon.name!t]，抵挡石魔像的攻击。"

translate schinese_rewrite mossgolem_battle_53613e40:

    # "You raise your fists in a block, defending yourself from the golem's attack."
    "你举起双拳架住，抵挡石魔像的攻击。"

translate schinese_rewrite mossgolem_battle_loop_ede74514:

    # "You slash your [pc.weapon.name!t] at the arm of the golem, but his magical aura repels the attack."
    "你挥动[pc.weapon.name!t]砍向石魔像的手臂，但他的魔法光环将这一击弹开。"

translate schinese_rewrite mossgolem_battle_loop_e321d8ca:

    # "You slam your [pc.weapon.name!t] at the golem's head, but his magical aura repels the attack."
    "你抡起[pc.weapon.name!t]砸向石魔像的头部，但他的魔法光环将这一击弹开。"

translate schinese_rewrite mossgolem_battle_loop_5a0b73a8:

    # "You aim and shoot your [pc.weapon.name!t] at the golem, but it seems to have missed."
    "你瞄准石魔像射出[pc.weapon.name!t]，但这一击似乎没有命中。"

translate schinese_rewrite mossgolem_battle_loop_e815f408:

    # "You throw a punch at the golem, but your punch meets air rather than the block of stone you expected."
    "你朝石魔像挥出一拳，拳头打中的只是空气，而不是你原以为会碰到的石块。"

translate schinese_rewrite mossgolem_battle_loop_643a09c8:
    ...
    "你挥动[pc.weapon.name!t]砍向苔藓石魔像的手臂，刀刃擦过岩石，从他身上削落几块碎石。"

translate schinese_rewrite mossgolem_battle_loop_bc5738de:

    # "You slash your [pc.weapon.name!t] across the golem's body, knocking him back a few steps. The golem quakes silently in anger."
    "你挥动[pc.weapon.name!t]横扫石魔像的身体，将他击退了几步。石魔像无声地颤抖着，满怀愤怒。"
...
translate schinese_rewrite mossgolem_battle_loop_d4dec8d4:
    ...
    "你抡起[pc.weapon.name!t]横扫石魔像的身体，将他击退了几步。石魔像无声地颤抖着，满怀愤怒。"

translate schinese_rewrite mossgolem_battle_loop_5017cd51:
    ...
    "你瞄准苔藓石魔像射出[pc.weapon.name!t]，箭矢正中他的手臂，将那条肢体的一大块削成了碎石。"

translate schinese_rewrite mossgolem_battle_loop_f70613a1:
    ...
    "你一边奔跑，一边用[pc.weapon.name!t]扫射石魔像的身体，将他击退了几步。石魔像无声地颤抖着，满怀愤怒。"

translate schinese_rewrite mossgolem_battle_loop_dda80880:
    ...
    "你一拳打向石魔像，正中那颗发光的蓝色核心。核心一阵摇曳，逐渐暗淡，石魔像似乎失去了维持自身形体的部分力量。"

translate schinese_rewrite mossgolem_battle_loop_ef6f4b5b:

    # "You punch into the golem's stomach, knocking him back a few steps. The golem quakes silently in anger."
    "你一拳击中石魔像的腹部，将他击退了几步。石魔像无声地颤抖着，满怀愤怒。"
...
translate schinese_rewrite mossgolem_battle_loop_7c6f4f33:
    ...
    "你挣扎着试图摆脱法术束缚，同时对石魔像造成了[oa[4]]点伤害。他的握力也随之减弱了。"
...
translate schinese_rewrite mossgolem_battle_loop_8e418f5c:
    ...
    "你一边与石魔像挣扎，一边试图把手伸到他胯下，想要激起他的反应。"

translate schinese_rewrite mossgolem_battle_loop_92dbba51:
    ...
    "你大胆的举动立刻让石魔像起了反应，他身上的苔藓剧烈颤抖起来，握力似乎也减弱了几分。"

translate schinese_rewrite mossgolem_battle_loop_f491da4a:
    ...
    "你转过身，一边摇晃臀部，一边用手抚遍自己结实的臀肉，感受并摩挲着自己的屁股。"

translate schinese_rewrite mossgolem_battle_loop_060474ad:
    ...
    "你用爪子轻轻蹭过自己的肉棒，从大腿内侧一路划到阴囊后方。你轻轻拉扯着双丸，妩媚地注视着苔藓石魔像。"

translate schinese_rewrite mossgolem_battle_loop_631c22d5:
    ...
    "你双手托住毛茸茸的胸膛，在乳头周围画着圆圈。你对苔藓石魔像露出微笑，同时让胸部轻轻上下晃动。"

translate schinese_rewrite mossgolem_battle_loop_60659c1c:

    # "You approach the golem before gently letting your hands wander inside the huge bush in his crotch area."
    "你走近石魔像，然后轻轻将双手探入他胯下那片巨大的苔藓丛中。"

translate schinese_rewrite mossgolem_battle_loop_b4cf221d:

    # "You continue your act for about a minute, but the moss golem doesn't even flinch."
    "你继续表演了大约一分钟，但苔藓石魔像甚至没有颤动一下。"

translate schinese_rewrite mossgolem_battle_loop_df9f0471:

    # "Disappointed, you back away before the golem can grab a hold of you."
    "你有些失望，在石魔像抓住你之前退了回去。"

translate schinese_rewrite mossgolem_battle_loop_775db50d:
    ...
    "你无法从他的脸上看出情欲，但通过苔藓的颤动，你可以断定他十分享受这一切。他的性欲增加了[player_flirt]点。"
...
translate schinese_rewrite mossgolem_battle_loop_d130a7f8:
    ...
    "你耗尽了所有气力，双膝跪倒在地。你躺在地上大口喘息，将自己交给了石魔像。"

translate schinese_rewrite mossgolem_battle_loop_85284344:

    # "Try as you might, you cannot escape from the golem's magical aura."
    "你竭尽全力，却还是无法逃离石魔像的魔法光晕。"

translate schinese_rewrite mossgolem_battle_loop_4f8cdb69:

    # "The golem falls with a huge thud on the ground."
    "石魔像轰然倒地，发出巨大的声响。"

translate schinese_rewrite mossgolem_battle_loop_37b66134:

    # "You don't know if your flirting worked, but it certainly put down the golem."
    "你不知道自己的挑逗是否奏效，但它确实放倒了石魔像。"

translate schinese_rewrite mossgolem_battle_loop_f00e2b24:

    # "As soon as the golem tries to attack, it is stabbed by a mysterious figure."
    "石魔像刚要发动攻击，就被一个神秘人物刺中了。"

translate schinese_rewrite mossgolem_battle_loop_b44c1b06:

    # l "Another save. You are lucky I went with you, disciple."
    l "又救了你一回。你真走运，幸好我和你一起来了，我的徒儿。"
...
translate schinese_rewrite mossgolem_battle_loop_d8f33499:
    ...
    "你很快认出了这低沉的声音。是洛萨尔——石魔像轰然倒地时，他出现在了它身后。"
...
translate schinese_rewrite mossgolem_battle_loop_88eafef6:
    ...
    "苔藓石魔像用右臂将你牢牢制住。你试图挣脱，却无济于事。"

translate schinese_rewrite mossgolem_battle_loop_4651dcfa:

    # "The golem swings his fist in your direction, hitting you in the chest. Your health decreases by [enemy_damage] HP."
    "石魔像朝你挥拳，击中了你的胸口。你的生命值减少了[enemy_damage]点。"

translate schinese_rewrite mossgolem_battle_loop_ba087092:
    ...
    "石魔像用藤蔓将你击倒。你昏迷了几秒，随后才站起身来。你的生命值减少了[enemy_damage]点。"

translate schinese_rewrite mossgolem_battle_loop_badf1f48:

    # "The golem swings his fist in your direction, but you manage to dodge the blow."
    "石魔像朝你挥拳，但你设法躲过了这一击。"

translate schinese_rewrite mossgolem_battle_loop_2c85f159:

    # "The golem tries to strike you down with his vines, but he missed the attack just by inches."
    "石魔像试图用藤蔓将你击倒，但这次攻击只差几寸便会命中你。"

translate schinese_rewrite mossgolem_battle_loop_96174b9e:

    # "The Moss Golem channels the water into a blue orb of regeneration. His body becomes revitalised by the power of water."
    "苔藓石魔像将水引导成一颗蓝色的再生之球。在水之力的作用下，它的身体重新焕发生机。"

translate schinese_rewrite mossgolem_lose_b1125d0b:
    ...
    "石魔像盯着虚弱的你，却没有就此罢手。你意识到自己恐怕无法活着离开这里。"

translate schinese_rewrite mossgolem_lose_f06e58bb:

    # "You close your eyes. You tell yourself that everything will be back to normal."
    "你闭上双眼，告诉自己一切都会恢复正常。"

translate schinese_rewrite mossgolem_lose_a20cefa7:

    # "..."
    "……"

translate schinese_rewrite mossgolem_win_abd39c56:

    # "You have gained [exp_drop] experience from the battle."
    "你从这场战斗中获得了[exp_drop]点经验。"

translate schinese_rewrite mossgolem_win_91f1d522:
